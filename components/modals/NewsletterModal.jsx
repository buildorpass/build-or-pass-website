        ...
        <div className="row md:child-cols-6 col-match g-0">
          ...
          <div>
            <div className="panel vstack self-center p-4 md:py-8 text-center">
              <h3 className="h3 md:h2">Join the course waitlist</h3>
              <p className="ft-tertiary">
                Get notified when the first cohort opens — projects, interview
                prep, get hired.
              </p>
              <div className="panel mt-2 lg:mt-4">
                ...
                <p className="fs-7 mt-2">No payment now. We will email you.</p>
              </div>
            </div>
          </div>
        </div>
