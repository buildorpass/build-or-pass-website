export const footerLinks = [
  {
    links: [
      ...
      { href: "/page-features", label: "Curriculum" },
  ...
  {
    links: [
      { href: "/page-features", label: "Projects" },
      { href: "/page-features", label: "Interview prep" },
      { href: "/page-features", label: "Get hired" },
      { href: "/page-pricing", label: "Join waitlist" },
  ...
  {
    links: [
      { href: "/page-contact", label: "Join waitlist" },
      { href: "/page-about", label: "Mentors" },
      { href: "/page-contact", label: "Talk to us" },
